 ...
 * 9 June 2023
 *
 * This program reads in pps signals an retransmits them at a higher voltage
 *
 * This program connect the NTP-PPS board to a time server, and continually
 * sends out PPS and ZDA pulses every second.
 *
...
const int PPS_OUT_PIN =
    17; // actually gpio 17, but I'm using the DOIT definitions.
...
static const unsigned char PROGMEM logo_bmp[] = {
    ...
    ,
...
String generateGPS() {
  ...
  // ZDA setup
  char buf[150];
  sprintf(buf, "$GPZDA,%02d%02d%02d.50,%02d,%02d,%04d,00,00*",
  ...
  sprintf(buf,
          "$GPRMC,%02d%02d%02d.00,A,0000.01,N,00000.01,W,0.0,0.0,%02d,%02d,%"
          "04d,0.0,W*",
          timeinfo->tm_hour, timeinfo->tm_min, timeinfo->tm_sec,
          timeinfo->tm_mday, timeinfo->tm_mon + 1, timeinfo->tm_year + 1900);
...
void printLocalTime() {
  ...
  udp.broadcastTo((gps_string).c_str(), UDP_PORT);
  for (auto it = tcp_clients.begin(); it != tcp_clients.end(); ++it) {
    if (it->connected()) {
      it->print(gps_string.c_str());
    } else {
...
void setup() {
  ...
  sprintf(ip_address, "%d.%d.%d.%d", ip_temp[0], ip_temp[1], ip_temp[2],
          ip_temp[3]);
  display.display();
